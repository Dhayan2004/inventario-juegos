/**
 * /success — client component (Polar mode)
 *
 * Polling profile.has_access hasta que el webhook subscription.active
 * concede acceso.
 *
  ...
  return (
    <main aria-labelledby="success-title">
      <Card>
        ...
        {status === 'verifying' && (
          <p role="status" aria-live="polite">Verificando tu pago...</p>
        )}
        {status === 'success' && (
          <p role="status" aria-live="polite">Pago confirmado. Redirigiendo...</p>
        )}
        {status === 'timeout' && (
          <>
            <p role="alert">
              Tu pago se está procesando. El acceso se activará en pocos minutos.
              Polar te enviará la factura por email.
            </p>
