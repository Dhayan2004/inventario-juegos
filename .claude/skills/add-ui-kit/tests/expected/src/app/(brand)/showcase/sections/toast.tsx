 ...
 *   - Enter: animate-in slide-in-from-bottom fade-in duration-[var(--motion-duration-base)] (~200ms)
 *   - Exit:  animate-out slide-out-to-right fade-out duration-[var(--motion-duration-fast)] (~150ms)
