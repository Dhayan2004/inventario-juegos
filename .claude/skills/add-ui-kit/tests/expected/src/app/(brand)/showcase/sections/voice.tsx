...
const HOOKS = ["El código mediocre se genera. El gran software se forja.", "Planifica primero. Construye después. Forja siempre.", "No vibe coding. Craft coding."]
const CTA_EXAMPLES = ["Si te sirve, compártelo.", "Pruébalo en tu próximo proyecto y avísame.", "Forge it."]
const SAFE_WORDS = ["forjar", "yunque", "fragua", "Blueprint", "build in public", "craft", "intencional"]
const AVOID_WORDS_PROJECT: string[] = []
  ...
  return (
    <section aria-labelledby="voice-title">
      ...
      <div className="mt-[var(--space-8)] grid gap-[var(--space-6)] md:grid-cols-2">
        ...
        <article className="rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface-elevated)] p-[var(--space-6)]">
          <p className="font-mono text-xs uppercase tracking-widest text-[var(--color-text-subtle)]">
            voice.cta_examples · style: Directo, no pushy
          </p>
