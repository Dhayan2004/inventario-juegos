...
const MOTION_AXES = [
  { name: 'energy', value: '{{ motion.energy }}' },
  { name: 'elasticity', value: '{{ motion.elasticity }}' },
  { name: 'directionality', value: '{{ motion.directionality }}' },
  { name: 'sequencing', value: '{{ motion.sequencing }}' },
  { name: 'distance', value: '{{ motion.distance }}' },
  { name: 'restraint', value: '{{ motion.restraint }}' },
]
