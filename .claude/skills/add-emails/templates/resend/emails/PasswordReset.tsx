/** PasswordResetEmail — R10. Cita: [memory:CONSTRAINTS.md#R10] · [memory:references#R-005] */
import {
...
export const PasswordResetEmail = ({
  firstName, productName, resetUrl, expiresInMinutes, unsubscribeUrl,
  ...
  return (
    <Html lang="es">
      <Head><title>Restablecé tu contraseña</title></Head>
      <Preview>{`Restablecé tu contraseña de ${productName}. Enlace válido ${expiresInMinutes} min.`}</Preview>
      <Body style={{ backgroundColor: colors.surface, fontFamily: 'Arial, Helvetica, sans-serif', margin: 0, padding: 0 }}>
        <Container style={{ maxWidth: '600px', margin: '0 auto', padding: '20px' }}>
          ...
          <Text style={{ color: colors.text, fontSize: '16px', lineHeight: '1.5' }}>
            Hola {firstName}, recibimos una solicitud para restablecer tu contraseña.
          </Text>
          ...
          <Text style={{ color: colors.warning, fontSize: '14px', fontWeight: 600 }}>
            Si vos no pediste este reset, ignorá este email y considerá cambiar tu contraseña actual por seguridad.
          </Text>
