-- 0003_email_subscriptions.sql
--
-- Email subscription state + suppression list + event log + admin audit.
-- RLS L-001 enforced en email_subscriptions (user-readable).
-- suppression_list / email_events / email_admin_actions: server-only.
--
-- Cita: [memory:lessons#L-001] · [memory:CONSTRAINTS.md#R14]
-- @see prompts/setup-resend.md · prompts/setup-sendgrid.md · references/refund-flow.md (R14 pattern)
